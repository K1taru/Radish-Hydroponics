...
### Drawing 4: Complete Physical Setup (Bird's Eye View)
...
```
    ...
    │   └────┬────┘                                           └────┬────┘        │
    │        │                                                     │             │
    │        │ Pump power cord (cut)                              │ Output wire  │
    │        │                                                     │ (cut)       │
    │        ▼                                                     ▼             │
    │   ┌─────────────────────────────────────────────────────────────────┐      │
    │   │                                                                 │      │
...
### Drawing 5: U-Connection Close-Up (Relay COM Terminals)
